...
const navItems = [
  { to: '/landlord',            label: 'Dashboard',   icon: '▦',  end: true },
  ...
  { to: '/landlord/settings',   label: 'Settings',    icon: '⚙️' },
]
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <span style={{ fontSize: 11, opacity: 0.5, fontWeight: 500, letterSpacing: '1.5px', textTransform: 'uppercase' }}>Landlord</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
